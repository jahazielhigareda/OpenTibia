...
namespace OpenTibia.Game.Common
{
    public class Server : IServer
    {
        ...
        {
            // For now, this is a no-op on the server-side concrete class if it's not intended to be used this way, 
            // but it must be implemented to satisfy IClientServer.
        }
        ...
        public void Start()
        {
            ...
            {
                Logger.WriteLine(ServerName + " " + ServerVersion + " - An open Tibia server developed by ");
                Logger.WriteLine("Copyright (C) 2024 ");
                ...
                Logger.WriteLine("Source code: https://github.com/OpenTibia");
                Logger.WriteLine();
